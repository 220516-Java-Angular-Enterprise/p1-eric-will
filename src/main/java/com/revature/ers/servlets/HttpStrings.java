...
public class HttpStrings {
    ...
    public String fourOOne(){
        return "<html lang=‘en’> <head> <title>HTTP Status 401 – Unauthorized</title> <style type=‘text/css’> body { font-family: Tahoma, Arial, sans-serif; } h1, h2, h3, b { color: white; background-color: #525D76; } h1 { font-size: 22px; } h2 { font-size: 16px; } h3 { font-size: 14px; } p { font-size: 12px; } a { color: black; } .line { height: 1px; background-color: #525D76; border: none; } </style> </head> <body> <h1>HTTP Status 403 – Forbidden</h1> <hr class='line' /> <p><b>Type</b> Status Report</p> <p><b>Message</b> An unauthenticated user is forbidden to view this page</p> <hr class='line' /> <h3>Apache Tomcat/10.0.21</h3> </body> </html>";
    }
